...
class Main {
  ...
  private static void gameLoop() {
    String lastComputerCity = null; /* Java вимагає ініціалізацію змінних */
    ...
    while (true) {/* бескінечний цикл */
      ...
      // перевіряємо, чи є в списку місто, яке ввід користувач
      ...
      if (lastComputerCity != null) {
        ...
        char firstInputChar = input.charAt(0); /* повертає перший символ слова, яке вводимо ми з клавыатури */
      ...
      char lastChar = input.charAt(input.length() - 1); /* повертає останній символ */
  ...
  private static void fullCities() {
